...
fprintf('The Confidence Level for the difference of means (sigma1 == sigma2): (%.3f, %.3f)\n', ci1, ci2);
...
fprintf('C.I. for the difference of means (sigma1 != sigma2): (%.3f, %.3f)\n', ci1, ci2);
...
ci1 = 1/f1* v1/v2;
ci2 = 1/f2* v1/v2;
fprintf('C.I. for the ratio of variances: (%.3f, %.3f)\n', ci1, ci2);
fprintf('C.I. for the ratio of std. deviations: (%.3f, %.3f)\n', sqrt(ci1), sqrt(ci2));
