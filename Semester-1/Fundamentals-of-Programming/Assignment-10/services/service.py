...
from src.util.util import my_shell_sort
from src.util.util import my_filter
...
class Service:
    ...
    def create_rentals_list_for_a_given_client(self, given_client_id):
        ...
        def filter_function(rental):
            return rental.client_id == int(given_client_id)

        rentals_list_for_given_client = my_filter(rentals_list, filter_function)
    ...
    def search_book_by_id(self, given_id):
        ...
        def filter_function(book):
            return re.search(given_id, str(book.book_id), re.IGNORECASE)

        book_matches_list = my_filter(books_list, filter_function)
    ...
    def search_book_by_title(self, given_title):
        ...
        def filter_function(book):
            return re.search(given_title, book.title, re.IGNORECASE)
    ...
    def search_book_by_author(self, given_author):
        ...
        def filter_function(book):
            return re.search(given_author, book.author, re.IGNORECASE)
    ...
    def search_client_by_name(self, given_name):
        ...
        def filter_function(client):
            return re.search(given_name, client.name, re.IGNORECASE)

        client_matches_list = my_filter(clients_list, filter_function)
    ...
    def search_client_by_id(self, given_id):
        ...
        def filter_function(client):
            return re.search(given_id, str(client.client_id), re.IGNORECASE)
    ...
    def create_and_sort_list_of_statistics_for_most_rented_books(self, most_rented_books_dictionary):
        ...
        def comparison_function(book_with_rentals1, book_with_rentals2):
            return book_with_rentals1.number_of_rentals < book_with_rentals2.number_of_rentals

        sorted_list_of_most_rented_books = my_shell_sort(most_rented_books_list, comparison_function)
        return sorted_list_of_most_rented_books
    ...
    def create_and_sort_list_of_statistics_for_most_active_clients(self, most_active_clients_dictionary):
        ...
        def comparison_function(client_with_rental_days1, client_with_rental_days2):
            return client_with_rental_days1.number_of_days_of_rentals < client_with_rental_days2.number_of_days_of_rentals

        sorted_list_of_most_active_clients = my_shell_sort(most_active_clients_list, comparison_function)
        return sorted_list_of_most_active_clients
    ...
    def create_and_sort_list_of_statistics_for_most_rented_authors(self, most_rented_author_dictionary):
        ...
        def comparison_function(author_with_rentals1, author_with_rentals2):
            return author_with_rentals1.number_of_rentals < author_with_rentals2.number_of_rentals

        sorted_list_of_most_rented_author = my_shell_sort(most_rented_author_list, comparison_function)
        return sorted_list_of_most_rented_author
